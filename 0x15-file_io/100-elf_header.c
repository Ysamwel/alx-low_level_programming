 ...
 * @e_ident: points to an array containing ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_entry - it prints to entry point of an ELF header.
 ...
 *
 * Description: if file close - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * @argc: integer of arguments supplied to program.
